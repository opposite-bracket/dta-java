...
/**
 *You are given a list of integers, myList, where some of the elements may be repeated. Your task is to write
 * a Java method that removes all duplicate elements from the list and returns a new list containing only
 * the unique elements.
 *
